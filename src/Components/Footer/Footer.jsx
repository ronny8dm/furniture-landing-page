        ...
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-9">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
                ...
                <p className='text-md text-gray-300'>@ 2022 <a className='underline' href="https://coder-portfolio.herokuapp.com/">Rhonny Diaz</a>. All rights reserved.</p>
              </div>
              <div>
                <div>
              ...
              <div>
                  ...
                  <ul  className='flex flex-col md:gap-5 gap-2'>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        ...
                        <span><a href="tel:+2 666327232147">+44 7853353755</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        <span><a href="mailto:ronnydiaz23@gmail.com"> <HiOutlineMail className='text-2xl' /></a></span>
                        <span><a href="mailto:ronnydiaz23@gmail.com">ronnydiaz23@gmail.com</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center my-6 ml-3'>
                        <span><a href="mailto:ronnydiaz23@gmail.com"> <FaFacebookF className='text-2xl' /></a></span>
                        <span><a href="mailto:ronnydiaz23@gmail.com"><BsInstagram className='text-2xl'/> </a></span>
                        <span><a href="mailto:ronnydiaz23@gmail.com"><AiOutlineTwitter className='text-2xl'/></a></span>
                    </li>
                  </ul>
                </div>
              </div>
